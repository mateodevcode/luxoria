...
const BotonWhatsapp = () => {
  ...
  return (
    <>
      ...
      <div
        className="fixed z-40 right-2 md:right-10 bottom-4 rounded-full cursor-pointer hover:text-primero/80 text-primero dark:text-primero dark:shadow-primero/10 shadow-segundo/10 hover:opacity-70 transition-all duration-300 hover:scale-105"
        onClick={() => {
      ...
      <AnimatePresence>
        {modalOpenBotonFlotante && (
          ...
          >
            <motion.div
              className="absolute bottom-16 right-16 md:right-24 z-40 w-72 h-80 bg-segundo/10 rounded-md border-0 shadow-lg overflow-hidden font-poppins"
